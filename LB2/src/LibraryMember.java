...
class LibraryMember {
    ...
    public LibraryMember(int id, String lastName, String firstName, String middleName, String phoneNumber, String address, Date lastVisitDate, boolean overdueIncidents, List<String> borrowedBooks) {
        this.id = id;
