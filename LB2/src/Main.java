...
public class Main {
    ...
    static void fillTestData() {
        ...
        libraryMembers[0] = new LibraryMember(1, "Степаненко", "Іван", "Олександрович", "123456789", "вул. Мазепи, 1", new Date(), false, books1);
        libraryMembers[1] = new LibraryMember(2, "Стеценко", "Петро", "Іванович", "987654321", "вул. Шевченка, 2", new Date(), true, books2);
    }
    ...
    static void printMembersWithOverdueIncidents() {
        ...
        for (LibraryMember member : libraryMembers) {
            if (member != null && member.isOverdueIncidents()) {
                System.out.println(member);
            }
        }
        System.out.println();
